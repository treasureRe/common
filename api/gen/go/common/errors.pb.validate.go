...
// Validate checks the field values on BusinessError with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *BusinessError) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on BusinessError with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in BusinessErrorMultiError, or
// nil if none found.
func (m *BusinessError) ValidateAll() error {
	return m.validate(true)
}

func (m *BusinessError) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return BusinessErrorMultiError(errors)
	}

	return nil
}

// BusinessErrorMultiError is an error wrapping multiple validation errors
// returned by BusinessError.ValidateAll() if the designated constraints
// aren't met.
type BusinessErrorMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m BusinessErrorMultiError) Error() string {
...
func (m BusinessErrorMultiError) AllErrors() []error { return m }

// BusinessErrorValidationError is the validation error returned by
// BusinessError.Validate if the designated constraints aren't met.
type BusinessErrorValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
func (e BusinessErrorValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e BusinessErrorValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e BusinessErrorValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e BusinessErrorValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e BusinessErrorValidationError) ErrorName() string { return "BusinessErrorValidationError" }

// Error satisfies the builtin error interface
func (e BusinessErrorValidationError) Error() string {
	cause := ""
	if e.cause != nil {
...
var _ error = BusinessErrorValidationError{}
